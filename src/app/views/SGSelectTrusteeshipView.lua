...
local SGSelectTrusteeshipView = {}
function SGSelectTrusteeshipView:initialize()
...
function SGSelectTrusteeshipView:layout(deskdata)
...
function SGSelectTrusteeshipView:freshTab(data, sender)
    if data ~= Tabs[1] then
...
function SGSelectTrusteeshipView:freshText(base)
	...
	intelligent:getChildByName('1'):getChildByName('text'):setString('八点' .. str)
	intelligent:getChildByName('2'):getChildByName('text'):setString('九点' .. str)
	intelligent:getChildByName('3'):getChildByName('text'):setString('三公' .. str)
end

function SGSelectTrusteeshipView:freshIntelligent(data, sender)
    local intelligent = self.MainPanel:getChildByName(data):getChildByName('intelligent')
...
function SGSelectTrusteeshipView:freshcolor(data, sender, intelligent)
    if intelligent then
...
function SGSelectTrusteeshipView:getOptionsIntelligentValue(fatherName)
    local value = nil
    for i, v in ipairs(Tabs) do
...
function SGSelectTrusteeshipView:freshTabNum(deskInfo)
    if deskInfo.gameplay == 1 then 
        self.MainPanel:getChildByName(Tabs[2]):setVisible(false)
    end
end

function SGSelectTrusteeshipView:getOptions()
    return self.options
end

function SGSelectTrusteeshipView:setOptions(option)
	self.options = option
	self:loadPutMoneyList()
	self:loadgetBankerList()
	self:loadBetting()
...
function SGSelectTrusteeshipView:freshHelpView(data)
...
function SGSelectTrusteeshipView:setVisibleAndColor(item, bool, color)
    item:getChildByName("select"):setVisible(bool)
    item:getChildByName('text'):setColor(color)
end

function SGSelectTrusteeshipView:hiddenPutMoneyList()
...
function SGSelectTrusteeshipView:loadPutMoneyList()
...
function SGSelectTrusteeshipView:loadgetBankerList()
...
function SGSelectTrusteeshipView:loadBetting()
...
function SGSelectTrusteeshipView:runbettingDownAction()
    local betting = self.MainPanel:getChildByName('betting')
    local moveTime = 0.2
...
function SGSelectTrusteeshipView:runbettingUpAction()
...
return SGSelectTrusteeshipView