...
function ZJHChatView:initialize()
end
...
function ZJHChatView.getChatsTbl()
    return chatsTbl
end

function ZJHChatView:getEmojiTbl()
    return emojiTbl
end

function ZJHChatView:layout(desk)
    self.desk = desk
...
function ZJHChatView:initShortcutList()
...
function ZJHChatView:freshBtnState(mode)
...
function ZJHChatView:freshListState(mode)
    local chattingRecord = self.MainPanel:getChildByName('chattingRecord')
    local mode = mode or 'shortcut'
    if mode == 'shortcut' then
...
function ZJHChatView:freshRecordList(msg)
...
function ZJHChatView:freshHeadImg(item, headUrl)
...
function ZJHChatView:getChatEditBoxInfo()
    local text = self.chatEditBox:getText()
    return text
end

function ZJHChatView:freshChatEditBox(content, enable)
    enable = enable or false
    self.chatEditBox:setText(content)
    self.chatEditBox:setEnabled(enable)
end

function ZJHChatView:initEmojiList()
...
function ZJHChatView:setBtnClickEvent(item, line, col)
    for i = 1, col do
...
function ZJHChatView:biaoqingRemind(idx, bool)
